...
namespace Polymorphism
{
    class Program
    {
        ...
        {
            private double nBasicSalary = 0.0;
            private double nBonuspercent = 0.0;

            private AppointmentType eAppointmentType;
            ...
            public clsSalaryCalculator(double nBSalary, AppointmentType eAppType)
            {
                this.nBasicSalary = nBSalary;
                this.eAppointmentType = eAppType;
            }
            ...
            public double getBonus()
            {
                ...
                if (eAppointmentType == AppointmentType.Permanent)
                {
                    nTotalSalary = nBasicSalary + nBasicSalary * 1.0;
                    return nTotalSalary;
                }
                else if (eAppointmentType == AppointmentType.Temporary)
                {
                    nTotalSalary = nBasicSalary + nBasicSalary * 0.5;
                    return nTotalSalary;
                }
                else if (eAppointmentType == AppointmentType.Casual)
                {
                    nTotalSalary = nBasicSalary + nBasicSalary * 0.1;
                    return nTotalSalary;
                }
                else
                {
        ...
        static void Main(string[] args)
        {
            ...
            clsSalaryCalculator oSCalcT1 = new clsSalaryCalculator(oTeacher1.BasicSalary, clsSalaryCalculator.AppointmentType.Permanent);
            oSCalcs[0] = oSCalcT1;
            ...
            clsSalaryCalculator oSCalcT2 = new clsSalaryCalculator(oTeacher2.BasicSalary, clsSalaryCalculator.AppointmentType.Temporary);
            oSCalcs[1] = oSCalcT2;
            ...
            clsSalaryCalculator oSCalcO = new clsSalaryCalculator(oOfficer.BasicSalary, clsSalaryCalculator.AppointmentType.Casual);
            oSCalcs[2] = oSCalcO;
            ...
            clsSalaryCalculator oSCalcS = new clsSalaryCalculator(oStaff.BasicSalary, clsSalaryCalculator.AppointmentType.Permanent);
            oSCalcs[3] = oSCalcS;
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                double nBonus = oSCalcs[i].getBonus();

                Console.WriteLine("-------------------");

                Console.WriteLine("Basic Salary:      " + oEmployees[i].BasicSalary);

                Console.WriteLine("Bonus:             " + nBonus);

                Console.WriteLine("Total Salary:      " + Convert.ToString(oEmployees[i].BasicSalary + nBonus));
