    ...
    class Program
    {
        ...
        public class clsTeacher : clsEmployee
        {
            ...
            private void getTotalSubordinateSalaries()
            {
                ...
                {
                    nTotalSalary = nTotalSalary + oEmployee.Grade.getHouseRentConveyance();
                }
        ...
        static void Main(string[] args)
        {
            ...
            clsGradeA oGradeAT1 = new clsGradeA(oTeacher1.BasicSalary);
            oTeacher1.Grade = oGradeAT1;
            ...
            clsGradeA oGradeAO1 = new clsGradeA(oOfficer.BasicSalary);
            oOfficer.Grade = oGradeAO1;
            ...
            clsGradeC oGradeCS1 = new clsGradeC(oOfficer.BasicSalary);
            oStaff.Grade = oGradeCS1;
