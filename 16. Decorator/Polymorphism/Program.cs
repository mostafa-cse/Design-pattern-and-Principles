...
namespace Polymorphism
{
    class Program
    {
        ...
        {
            protected double nBasePricePizza;

            public virtual double getPrice()
            {
                return this.nBasePricePizza;
            }
        }
        ...
        public abstract class clsTopping : clsBasePizza
        {
            ...
            protected double nBasePriceTopping;
            ...
            {
                return (this.oPizza.getPrice() + this.nBasePriceTopping);
            }
        }
