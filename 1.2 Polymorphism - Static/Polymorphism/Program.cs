...
namespace Polymorphism
{
    class Program
    {
        public class clsEmployee        // Declare a class
        {
            ...
            private static int _nEmploueeCounter = 0;
            ...
            public clsEmployee()        // Constructor
            {
                ...
                _sPhone = "";
                _sDesignation = "";
                _nEmploueeCounter = _nEmploueeCounter + 1;
            }
            ...
            public int NumberOfEmployees         // Properties
            {
                get
                {
                    return _nEmploueeCounter;
                }
            }
        ...
        {
            clsEmployee[] oEmployees = new clsEmployee[3];
            ...
            oTeacher2.Department = "ITOCD";
            oTeacher2.Papers = 2; ;

            oEmployees[2] = oTeacher2;
            ...
            Console.WriteLine("Total Number of Employees: " + oTeacher1.NumberOfEmployees);
